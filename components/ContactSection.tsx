      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-lg p-8 text-center hover:shadow-lg transition-shadow">
            ...
            <p className="text-lg font-semibold text-green-600 mb-4">{BUSINESS_INFO.phone}</p>
            <a href={CONTACT_LINKS.whatsapp} target="_blank" rel="noopener noreferrer" className="inline-block px-6 py-2 bg-green-600 text-white rounded-lg font-semibold hover:bg-green-700 transition-colors">
              Chat Now
            </a>
          </div>
          ...
          <div className="bg-gradient-to-br from-amber-50 to-amber-100 rounded-lg p-8 text-center hover:shadow-lg transition-shadow">
            ...
            <p className="text-lg font-semibold text-amber-600 mb-4">{BUSINESS_INFO.phone}</p>
            <a href={CONTACT_LINKS.phone} className="inline-block px-6 py-2 bg-amber-600 text-white rounded-lg font-semibold hover:bg-amber-700 transition-colors">
              Call Now
            </a>
          </div>
